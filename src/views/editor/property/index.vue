<template>
    <side-panel :title="'属性面板'" :width="300" :direction="'right'" :mode="closeMode.complete" :show="useStore.show"
        @close="useStore.show = false">
    </side-panel>
    <div class="open-button-container" :class="{ 'show': !useStore.show }" @mousedown="useStore.show = true">
        <div class="button">
